// Remove Advertising Identifier (IDFA) references from the Google Analytics plugin.
// This script is referenced via a hook in the file `config.xml`.
// Why? If the advertising identifier is referenced by any binary, this app will be flagged
// in the Apple App Store. So, remove the pertinent binaries because we do not
// use the advertising identifier via the Google Analytics plugin or otherwise.
// See: https://github.com/danwilson/google-analytics-plugin/issues/218#issuecomment-349078091
...
// Source: https://gist.github.com/SteveKennedy/7edbe6e5f54d8582a27acbfd8d704c12
